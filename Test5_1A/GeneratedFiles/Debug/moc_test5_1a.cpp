...
**
** Created: Sat Jul 23 21:56:15 2016
...
static const char qt_meta_stringdata_Test5_1A[] = {
    "Test5_1A\0\0int\0checked\0OnClickedButton(bool)\0"
};

const QMetaObject Test5_1A::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_Test5_1A,
      qt_meta_data_Test5_1A, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Test5_1A::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Test5_1A))
...
int Test5_1A::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: { int _r = OnClickedButton((*reinterpret_cast< bool(*)>(_a[1])));
