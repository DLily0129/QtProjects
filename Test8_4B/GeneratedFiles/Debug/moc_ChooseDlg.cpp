...
**
** Created: Thu Aug 11 21:22:09 2016
...
static const char qt_meta_stringdata_ChooseDlg[] = {
    "ChooseDlg\0\0int\0OnbtnStart(bool)\0"
};

const QMetaObject ChooseDlg::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_ChooseDlg,
      qt_meta_data_ChooseDlg, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &ChooseDlg::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ChooseDlg))
...
int ChooseDlg::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: { int _r = OnbtnStart((*reinterpret_cast< bool(*)>(_a[1])));
